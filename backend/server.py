...
EUROPEAN_SUBSIDIES = [
    {
        "name": "DiscoverEU",
        "emoji": "🚂",
        "description": "Si tienes 18 anos, puedes conseguir un pase Interrail gratis para recorrer Europa en tren. Lo sortean dos veces al ano.",
        "amount": "Gratis (pase de ~251€)",
        "savings_value": 251,
        "max_age": 18,
        "min_age": 18,
        ...
        "how_to": "Registrate en youth.europa.eu cuando abra la convocatoria. Necesitas pasaporte europeo y tener 18 anos.",
    },
    {
        "name": "Erasmus+ Beca de Viaje",
        "emoji": "🎓",
        "description": "Si eres estudiante Erasmus, tu universidad te da una ayuda extra para cubrir gastos de transporte al pais de destino.",
        "amount": "Hasta 275€",
        "savings_value": 275,
        "max_age": 30,
        "min_age": 18,
        ...
        "eligible_countries": ["EU"],
        "next_deadline": "Depende de tu universidad",
        "how_to": "Habla con la oficina de relaciones internacionales de tu universidad. Se gestiona automaticamente si ya eres Erasmus.",
    },
    {
        "name": "Cheques Vacaciones (Francia)",
        "emoji": "🇫🇷",
        "description": "Si trabajas en Francia (incluso media jornada o practicas), tu empleador puede darte cheques para pagar viajes, hoteles y transporte.",
        "amount": "Hasta 500€/ano",
        "savings_value": 500,
        "max_age": 99,
        "min_age": 16,
        "requires_student": False,
        "eligible_countries": ["FR"],
        "next_deadline": "Disponible todo el ano",
        "how_to": "Pregunta a tu empleador o al departamento de RRHH si ofrecen ANCV Cheques-Vacances.",
    },
    {
        "name": "Interrail Joven (-27)",
        "emoji": "🚄",
        "description": "Si tienes menos de 27, el pase Interrail te sale con descuento. Viaja en tren por 33 paises europeos.",
        "amount": "Ahorro de ~100€",
        "savings_value": 100,
        "max_age": 27,
        "min_age": 12,
        "requires_student": False,
        "eligible_countries": ["EU"],
        "next_deadline": "Disponible todo el ano",
        "how_to": "Compra el pase Youth en interrail.eu. Selecciona la opcion para menores de 27.",
    },
    {
        "name": "Carnet Joven Europeo (EYCA)",
        "emoji": "💳",
        "description": "Tarjeta con descuentos en transporte, museos, hostels y restaurantes en 38 paises. Cuesta entre 5-15€.",
        "amount": "Ahorro medio ~80€/viaje",
        "savings_value": 80,
        "max_age": 30,
        "min_age": 14,
        "requires_student": False,
        "eligible_countries": ["EU"],
        "next_deadline": "Disponible todo el ano",
        "how_to": "Solicita tu carnet en la web de juventud de tu pais. En Espana: carnejoven.es. En Francia: carte-jeunes.fr.",
    },
    {
        "name": "BahnCard 25 Joven (Alemania)",
        "emoji": "🇩🇪",
        "description": "Si viajas por Alemania, con esta tarjeta tienes 25% de descuento en todos los trenes. Ideal si tu destino es Berlin, Munich, etc.",
        "amount": "Tarjeta 36.90€ (ahorras ~120€)",
        "savings_value": 120,
        "max_age": 27,
        "min_age": 18,
        "requires_student": False,
        "eligible_countries": ["DE", "AT", "CH"],
        "next_deadline": "Disponible todo el ano",
        "how_to": "Comprala en bahn.de. Necesitas una direccion en Alemania o puedes usar la version digital.",
    },
]
...
async def calculate_subsidies(age: int = 22, is_student: bool = True, country: str = "FR", has_erasmus: bool = False):
    ...
    for subsidy in EUROPEAN_SUBSIDIES:
        ...
        result = {
            "name": subsidy["name"],
            "emoji": subsidy.get("emoji", ""),
            "description": subsidy["description"],
            "amount": subsidy["amount"],
            "applies": applies,
            "how_to": subsidy.get("how_to", ""),
            "next_deadline": subsidy["next_deadline"],
        }
        applicable.append(result)
        
        if applies:
            total_savings += subsidy.get("savings_value", 0)
